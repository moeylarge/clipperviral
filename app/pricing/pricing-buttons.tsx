...
export function PricingButtons({ showPortal, portalOnly = false }: { showPortal: boolean; portalOnly?: boolean }) {
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <section className="grid gap-5 rounded-2xl border border-black/[0.06] bg-white p-6 shadow-[0_18px_50px_rgba(0,0,0,0.05)]">
            <div className="grid gap-2">
              ...
              <p className="text-sm leading-6 text-[#6e6e73]">7-day free trial. Cancel anytime.</p>
            </div>
            <button
              type="button"
